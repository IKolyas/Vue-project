...
export default new Vuex.Store({
  state: {
    ...
    basketURL: "https://github.com/IKolyas/Vue-project/tree/master/store_server/api/basket",
    catalogUrl: "https://github.com/IKolyas/Vue-project/tree/master/store_server/api/catalog",
    qItemPages: 6,
    priceFilter: {
      min: 0,
      max: 1000
